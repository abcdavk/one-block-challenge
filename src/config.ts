import { ItemGenerator, ShopItem } from "./main";

// Shop sellable item list
export const itemSellableRegistry: ShopItem[] = [
...
export const itemBuyableRegistry: ShopItem[] = [
  { id: "minecraft:bundle",             price: 50 },
  { id: "minecraft:experience_bottle",  price: 25 },
  { id: "minecraft:totem_of_undying",   price: 1000 },
  { id: "minecraft:enchanted_book",     price: 600,   enchantment: [{ id: "fire_aspect", level: 2 }] },
  { id: "minecraft:enchanted_book",     price: 1200,  enchantment: [{ id: "silk_touch", level: 1 }] },
  { id: "minecraft:enchanted_book",     price: 800,   enchantment: [{ id: "looting", level: 3 }] },
  { id: "minecraft:enchanted_book",     price: 1000,  enchantment: [{ id: "efficiency", level: 5 }] },
  { id: "minecraft:enchanted_book",     price: 1500,  enchantment: [{ id: "fortune", level: 3 }] },
  { id: "minecraft:enchanted_book",     price: 500,   enchantment: [{ id: "flame", level: 1 }] },
  { id: "minecraft:enchanted_book",     price: 1500,  enchantment: [{ id: "infinity", level: 1 }] },
  { id: "minecraft:enchanted_book",     price: 1000,  enchantment: [{ id: "swift_sneak", level: 2 }] },
  { id: "minecraft:enchanted_book",     price: 1500,  enchantment: [{ id: "sharpness", level: 5 }] },
  { id: "minecraft:enchanted_book",     price: 500,   enchantment: [{ id: "knockback", level: 2 }] },
  { id: "minecraft:enchanted_book",     price: 600,   enchantment: [{ id: "respiration", level: 3 }] },
  { id: "minecraft:enchanted_book",     price: 1000,  enchantment: [{ id: "feather_falling", level: 4 }] },
  { id: "minecraft:enchanted_book",     price: 600,   enchantment: [{ id: "fire_protection", level: 4 }] },
  { id: "minecraft:enchanted_book",     price: 1500,  enchantment: [{ id: "protection", level: 4 }] },
...
// Generator settings
export const generatorRegistry: ItemGenerator[] = [
  {
