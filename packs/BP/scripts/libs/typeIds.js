export const typeIdToID = new Map([
    ...
    ['minecraft:wool', 768],
    ['minecraft:carpet', 769],
    ['minecraft:log', 770],
    ['minecraft:fence', 771],
    ['minecraft:stonebrick', 772],
    ['minecraft:coral_block', 773],
    ['minecraft:stone_block_slab', 774],
    ['minecraft:stone_block_slab2', 775],
    ['minecraft:stone_block_slab3', 776],
    ['minecraft:stone_block_slab4', 777],
    ['minecraft:double_stone_block_slab', 778],
    ['minecraft:double_stone_block_slab2', 779],
    ['minecraft:double_stone_block_slab3', 780],
    ['minecraft:double_stone_block_slab4', 781],
    ['minecraft:coral_fan', 782],
    ['minecraft:coral_fan_dead', 783],
    ['minecraft:sapling', 784],
    ['minecraft:leaves', 785],
    ['minecraft:leaves2', 786],
    ['minecraft:wooden_slab', 787],
    ['minecraft:red_flower', 788],
    ['minecraft:double_plant', 789],
    ['minecraft:double_wooden_slab', 790],
    ['minecraft:coral', 791],
    ['minecraft:tallgrass', 792],
    ['minecraft:log2', 793],
    ['minecraft:monster_egg', 794],
    ['minecraft:concrete', 795],
    ['minecraft:concrete_powder', 796],
    ['minecraft:stained_glass', 797],
    ['minecraft:stained_glass_pane', 798],
    ['minecraft:shulker_box', 799],
    ['minecraft:wood', 800],
    ['minecraft:music_disc_creator', 801],
    ['minecraft:music_disc_creator_music_box', 802],
    ['minecraft:music_disc_precipice', 803],
    ['minecraft:chemistry_table', 804],
    ['minecraft:hard_stained_glass', 805],
    ['minecraft:hard_stained_glass_pane', 806],
    ['minecraft:colored_torch_rg', 807],
    ['minecraft:colored_torch_bp', 808],
    ['minecraft:light_block', 809],
    ['minecraft:boat', 810],
    ['minecraft:dye', 811],
    ['minecraft:banner_pattern', 812],
    ['minecraft:spawn_egg', 813],
    ['minecraft:end_crystal', 814],
    ['minecraft:glow_berries', 815]
]);
